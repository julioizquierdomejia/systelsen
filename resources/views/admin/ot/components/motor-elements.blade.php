<div class="form-group row align-items-center" :class="{'has-danger': errors.has('description'), 'has-success': fields.description && fields.description.valid }">
    <label for="description" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.motor.columns.description') }}</label>
        ...
        <div>
            <wysiwyg v-model="motor.description" v-validate="'required'" id="description" name="description" :config="mediaWysiwygConfig"></wysiwyg>
        </div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('code'), 'has-success': fields.code && fields.code.valid }">
    <label for="code" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.motor.columns.code') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="motor.code" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('code'), 'form-control-success': fields.code && fields.code.valid}" id="code" name="code" placeholder="{{ trans('admin.motor.columns.code') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('brand_id'), 'has-success': fields.brand_id && fields.brand_id.valid }">
    <label for="brand_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.motor.columns.brand_id') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <!-- <input type="text" v-model="motor.brand_id" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('brand_id'), 'form-control-success': fields.brand_id && fields.brand_id.valid}" id="brand_id" name="brand_id" placeholder="{{ trans('admin.motor.columns.brand_id') }}"> -->
        <multiselect v-model="motor.brand_id" placeholder="{{ trans('brackets/admin-ui::admin.forms.select_options') }}" track-by="id" label="name" :options="{{ $brands->toJson() }}" :searchable="true" :allow-empty="false" open-direction="bottom"></multiselect>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('model_id'), 'has-success': fields.model_id && fields.model_id.valid }">
    <label for="model_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.motor.columns.model_id') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <!-- <input type="text" v-model="motor.model_id" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('model_id'), 'form-control-success': fields.model_id && fields.model_id.valid}" id="model_id" name="model_id" placeholder="{{ trans('admin.motor.columns.model_id') }}"> -->
        <multiselect v-model="motor.model_id" placeholder="{{ trans('brackets/admin-ui::admin.forms.select_options') }}" track-by="id" label="name" :options="{{ $models->toJson() }}" :searchable="true" :allow-empty="false" open-direction="bottom"></multiselect>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('volt'), 'has-success': fields.volt && fields.volt.valid }">
    <label for="volt" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.motor.columns.volt') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="motor.volt" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('volt'), 'form-control-success': fields.volt && fields.volt.valid}" id="volt" name="volt" placeholder="{{ trans('admin.motor.columns.volt') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('speed'), 'has-success': fields.speed && fields.speed.valid }">
    <label for="speed" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.motor.columns.speed') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="motor.speed" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('speed'), 'form-control-success': fields.speed && fields.speed.valid}" id="speed" name="speed" placeholder="{{ trans('admin.motor.columns.speed') }}">
